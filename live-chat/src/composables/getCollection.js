...
import { projectFirestore } from '../firebase/config' //untuk interaksi project dengan database
...
const getCollection = (collection) => {
    ...
    //realtime listener(fungsi const unsub membatasi listener berjalan)
    ...
    const unsub = collectionRef.onSnapshot((snap) => {
        ...
        error.value = err.value = 'could not fetch data'
    })
